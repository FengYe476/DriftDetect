...
CHECKPOINT = REPO_ROOT / "results" / "month8_moment_match" / "latest.pt"
OUTPUT_DIR = REPO_ROOT / "results" / "month8_controlled" / "rollouts_moment_match"
MANIFEST = OUTPUT_DIR / "manifest_moment_match.json"
